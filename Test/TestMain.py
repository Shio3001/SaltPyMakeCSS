...
ani2_test1.add_index(progress_time=0, key="transform", val=rotate1a)
ani2_test1.add_index(progress_time=100, key="transform", val=rotate1b)
...
ani2_test2 = class_forprocess.AnimationClass(animation_name="tokushima")
...
# test2.add_animation(ani2_test1)
